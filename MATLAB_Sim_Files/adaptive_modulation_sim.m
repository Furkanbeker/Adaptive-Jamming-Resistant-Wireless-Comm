...
% En küçük ortak uzunlukta hizalama (byte'a tam bölünen kısım)
...
% Modülasyona göre bit sayısını döndürür
...
% Modülasyona göre seviye dizisi döndürür
...
% Bitleri sembollere modüle eder
