...
class QAM_16_try_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QAM_16_try_2")
        ...
        self.qtgui_const_sink_x_1_0.set_y_axis((-5), 5)
        self.qtgui_const_sink_x_1_0.set_x_axis((-5), 5)
        ...
        self.qtgui_const_sink_x_0_0.set_x_axis((-5), 5)
        ...
        self.digital_chunks_to_symbols_xx_0_0 = digital.chunks_to_symbols_bc([(-3-3*1j), (-3-1*1j), (-3+1*1j), (-3+3*1j), (-1-3*1j), (-1-1*1j), (-1+1*1j), (-1+3*1j), ( 1-3*1j), ( 1-1*1j), ( 1+1*1j), ( 1+3*1j), ( 3-3*1j), ( 3-1*1j), ( 3+1*1j), ( 3+3*1j)], 1)
        ...
        self.analog_random_source_x_0_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 16, 10000))), True)
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.digital_binary_slicer_fb_0_0, 0))
...
def main(top_block_cls=QAM_16_try_2, options=None):
