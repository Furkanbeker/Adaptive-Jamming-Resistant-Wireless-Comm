...
class QSFM_try_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QSFM_try_2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QSFM_try_2")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QSFM_try_2")
        ...
        self.connect((self.blocks_repeat_0, 0), (self.blocks_uchar_to_float_2_0, 0))
        self.connect((self.blocks_repeat_0, 0), (self.digital_chunks_to_symbols_xx_0_0, 0))
...
def main(top_block_cls=QSFM_try_2, options=None):
