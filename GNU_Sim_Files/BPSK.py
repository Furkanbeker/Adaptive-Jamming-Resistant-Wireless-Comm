...
class BPSK_try_3_txt(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK_try_3_txt", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK_try_3_txt")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BPSK_try_3_txt")
        ...
        self._noise_var_win = qtgui.RangeWidget(self._noise_var_range, self.set_noise_var, "Noise Level", "eng_slider", float, QtCore.Qt.Horizontal)
        ...
        self.qtgui_time_sink_x_2.set_y_axis(0, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_2_win, 4, 0, 1, 3)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_win, 10, 3, 1, 3)
        ...
        self.qtgui_time_sink_x_0_1.set_y_axis(-0.1, 1.2)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_win, 12, 0, 2, 6)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_0_0_win, 3, 0, 1, 6)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_win, 6, 2, 1, 2)
        for r in range(6, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.qtgui_number_sink_1.set_title('SNR')
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_1_win, 2, 0, 1, 6)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.qtgui_number_sink_0.set_title('Bit Error Rate (BER)')
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_0_win, 1, 0, 1, 6)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_0_win, 5, 3, 1, 3)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_win, 4, 3, 1, 3)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.qtgui_freq_sink_x_0.set_y_axis((-80), 70)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_win, 6, 4, 1, 2)
        for r in range(6, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.probe_tx = blocks.probe_signal_c()
        self.probe_rx = blocks.probe_signal_c()
        ...
        self.blocks_moving_average_xx_0 = blocks.moving_average_ff(1000, 1, 1, 1)
        self.blocks_float_to_complex_2 = blocks.float_to_complex(1)
        self.blocks_float_to_complex_1 = blocks.float_to_complex(1)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\mfb36\\Desktop\\input.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\mfb36\\Desktop\\output.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_divide_xx_0 = blocks.divide_ff(1)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 36)
        ...
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, noise_var, 0)
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.probe_tx, 0))
        self.connect((self.blocks_float_to_complex_0, 0), (self.qtgui_const_sink_x_1_0, 0))
        ...
        self.connect((self.blocks_float_to_complex_2, 0), (self.blocks_complex_to_mag_squared_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.digital_costas_loop_cc_0, 0))
        self.connect((self.blocks_nlog10_ff_0, 0), (self.qtgui_number_sink_1, 0))
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_repeat_0_0, 0), (self.blocks_uchar_to_float_2, 0))
        self.connect((self.blocks_repeat_0_0, 0), (self.fec_ber_bf_0, 0))
        self.connect((self.blocks_uchar_to_float_0, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.blocks_uchar_to_float_0, 0), (self.qtgui_time_sink_x_0_1, 1))
        ...
        self.connect((self.blocks_uchar_to_float_2, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_uchar_to_float_2, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_uchar_to_float_2, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_repeat_0_0, 0))
        self.connect((self.channels_channel_model_0, 0), (self.blocks_multiply_xx_1, 0))
        self.connect((self.channels_channel_model_0, 0), (self.probe_rx, 0))
        ...
        self.connect((self.fec_ber_bf_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 300, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=BPSK_try_3_txt, options=None):
